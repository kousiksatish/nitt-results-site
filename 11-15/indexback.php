...
while($col = mysql_fetch_array($query)) {
	...
	{
?>
temp.push('<?php if ($row[$col['Field']] == 2) echo ' - '; else echo $row[$col['Field']];?>');
<?php
}}
?>
